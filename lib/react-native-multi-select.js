...
export default class MultiSelect extends Component {
  ...
  static defaultProps = {
    ...
    tagBackgroundColor: colorPack.primary,
    fontFamily: '',
  ...
  _displaySelectedItems = optionalSelctedItems => {
    ...
    return actualSelectedItems.map(singleSelectedItem => {
      ...
      if (!item[displayKey] || !item) return null
      return (
        <View
          style={{
            overflow: 'hidden',
        ...
        >
          ...
          <TouchableOpacity onPress={() => this._removeItem(item)} style={{ borderTopRightRadius: 20, borderBottomRightRadius: 20 }}>
            <Icon name='close' style={{ color: tagRemoveIconColor, fontSize: 16, marginHorizontal: 6, marginVertical: 7 }} />
          </TouchableOpacity>
        </View>
      )
    })
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      name={hideSubmitButton ? 'menu-up' : 'menu-down'}
